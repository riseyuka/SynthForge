 ...
 * This file demonstrates how to integrate Synthforge with a web frontend
 */

// For React/Vue/Angular applications
export class SynthforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SynthforgeClient(provider, contractAddress);
